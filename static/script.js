...
const touchDevice =
  navigator.maxTouchPoints & 0xff || "ontouchstart" in document.documentElement;
...
window.onmousemove = touchDevice
  ? null
  : (e) => {
...
document.getElementById("mobile-contact").addEventListener("click", toggleNav);
